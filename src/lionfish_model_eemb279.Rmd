...
Next, we use the parameters from their best-fit seasonalized von Bertalanffy growth model to recreate the growth curve, showing the relationship between age and length for lionfish. However, we also explore how different values of the seasonality coefficient affect the results of the model (Figure 2). 
