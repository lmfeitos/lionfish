...
# Works!
fl_plot <- ggplot(data = lf_sim_fl_long) +
  geom_density_line(aes(x = length, color = time, fill = time), 
                    alpha = 0.5) +
  labs(color = NULL,
       fill = NULL,
...
# Works!
m_plot <- ggplot(data = lf_sim_m_long) +
  geom_density_line(aes(x = length, color = time, fill = time), 
                    alpha = 0.5) +
  labs(color = NULL,
       fill = NULL,
...
# Works!
fn_plot <- ggplot(data = lf_sim_fn_long) +
  geom_density_line(aes(x = length, color = time, fill = time), 
                    alpha = 0.5) +
  labs(color = NULL,
       fill = NULL,
...
rj_plot <- ggplot(data = lf_sim_rj_long) +
  geom_density_line(aes(x = length, color = time, fill = time), 
                    alpha = 0.5) +
  labs(color = NULL,
       fill = NULL,
